...
// MongoDB URI
const mongoURI = "mongodb+srv://aathiabhishek2001:AathiCOOP@clusterapi.ppub7.mongodb.net/?retryWrites=true&w=majority&appName=ClusterAPI";
...
app.get('/fetch-data', async (req, res) => {
    try {
        const url = 'https://eu.kobotoolbox.org/assets/a6arg9iDUcubfTc5FwQWsQ/submissions/?format=json';
        ...
        const promises = data.map(async (item) => {
            try {
                ...
                console.error(`Error updating or inserting document with _id ${item._id}:`, err);
            }
        });
